...
struct ProductCard_Previews: PreviewProvider {
    static var previews: some View {
        ProductCard(title: "SMOOTHIE BOWL", description: "With extra coconut", image: Image("Smoothie_Bowl"), price: 15.00, peopleCount: 2, ingredientCount: 12, category: "FEELING S", buttonHandler: nil)
    }
}
